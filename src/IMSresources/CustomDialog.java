...
public class CustomDialog {
	...
	public static void show(Context context, int icon, String title, String msg, String positiveText, DialogInterface.OnClickListener positive, String negativeText, DialogInterface.OnClickListener negative){
		...
		View layout = inflater.inflate(tesis.sos2.R.layout.custom_dialog, null);

		ImageView ivIcon = (ImageView) layout.findViewById(tesis.sos2.R.id.custom_dialog_imageView_icon);
		ivIcon.setImageResource(icon);
		TextView tvTitle = (TextView) layout.findViewById(tesis.sos2.R.id.custom_dialog_textView_title);
		tvTitle.setText((title == null) ? "" : title);
		TextView tvMsg = (TextView) layout.findViewById(tesis.sos2.R.id.custom_dialog_textView_msg);
		tvMsg.setText(msg);
